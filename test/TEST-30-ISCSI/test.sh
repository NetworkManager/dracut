...
test_setup() {
    ...
    dd if=/dev/null of=$TESTDIR/root.ext3 bs=1M seek=43
    dd if=/dev/null of=$TESTDIR/iscsidisk2.img bs=1M seek=43
    dd if=/dev/null of=$TESTDIR/iscsidisk3.img bs=1M seek=43
